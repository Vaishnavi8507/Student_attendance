...
import 'package:student_attendance/helpers/date_helper.dart';
  ...
  Future _scanQR(String name) async {
    try {
      ...
      if (cameraScanResult.isNotEmpty) {
        ...
        String teacherName = cameraScanResult.substring(15);
        String subject = cameraScanResult.substring(0, 6);
        String batch = cameraScanResult.substring(8, 13);
