...
class _SomeSubjectScreenState extends State<SomeSubjectScreen> {
  ...
  Future<bool> checkExistence(String formattedDate) async {
    ...
    final documentsSnapshot = await FirebaseFirestore.instance
        ...
        .get();
    print("Documents Snapshot: ${documentsSnapshot.docs.length} documents found");
  ...
  void setDate() async {
    ...
    if (date != null) {
     ...
     // String SelectedDate = DateFormat('d-M-y').format(date);
      setState(() {
        selectedDate = "$day $month, $year";
      });
    }
    setState(() {
      exists = checkExistence(selectedDate);
    });
  }
